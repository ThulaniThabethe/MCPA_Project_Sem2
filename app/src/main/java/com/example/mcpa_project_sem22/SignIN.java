...
public class SignIN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignIN.this, MCPASignupActivity.class);
        ...
        justBrowsingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignIN.this, PromotionsActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void loginUser(final String email, final String password) {
        String url = "http://192.168.0.203/MCPA/login.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (jsonResponse.getBoolean("success")) {
                                ...
                                Toast.makeText(SignIN.this, "Login Failed: " + errorMessage, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Log.e(TAG, "JSON parsing error: " + e.getMessage());
                            Toast.makeText(SignIN.this, "Error parsing server response.", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
